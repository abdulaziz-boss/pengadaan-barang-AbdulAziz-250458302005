    ...
    <div class="sidebar-wrapper active ps ps--active-y">
        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ request()->routeIs('staff.categories.index') ? 'active' : '' }}">
                    <a href="{{ route('staff.categories.index')}}" class="sidebar-link" wire:navigate>
                        <i class="bi bi-stack"></i>
                        <span>List Kategori</span>
                    </a>
                </li>

                <li class="sidebar-item {{ request()->routeIs('staff.barangs.index') ? 'active' : '' }}">
                    <a href="{{ route('staff.barangs.index') }}" class="sidebar-link" wire:navigate>
                    <i class="bi bi-box-seam-fill"></i>
                        <span>List Barang</span>
                    </a>
                </li>

                <li class="sidebar-item {{ request()->routeIs('staff.pengadaans.index') ? 'active' : '' }}">
                    <a href="{{ route('staff.pengadaans.index') }}" class="sidebar-link" wire:navigate>
                        <i class="bi bi-clock-history me-2"></i>
                        <span>List Pengadaan</span>
                    </a>
                </li>

                <li class="sidebar-item {{ request()->routeIs('staff.pengadaanitems.index') ? 'active' : '' }}">
                    <a href="{{ route('staff.pengadaanitems.index') }}" class="sidebar-link" wire:navigate>
                    <i class="bi bi-clipboard2-check-fill"></i>
                        <span>Ajukan Pengadaan</span>
                    </a>
                </li>

                <li class="sidebar-item {{ request()->routeIs('staff.profile.index') ? 'active' : '' }}">
                    <a href="{{ route('staff.profile.index') }}" class="sidebar-link" wire:navigate>
