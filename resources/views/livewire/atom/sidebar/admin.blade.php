        ...
        <div class="sidebar-menu">
            <ul class="menu">
                ...
                <li class="sidebar-item {{ request()->routeIs('admin.categories') ? 'active' : '' }}">
                    <a href="{{ route('admin.categories')}}" class="sidebar-link" wire:navigate>
                        <i class="bi bi-stack"></i>
                        <span>List Kategori</span>
                    </a>
                </li>

                <li class="sidebar-item {{ request()->routeIs('admin.barangs.index') ? 'active' : '' }}">
                    <a href="{{ route('admin.barangs.index') }}" class="sidebar-link" wire:navigate>
                    <i class="bi bi-box-seam-fill"></i>
                        <span>List Barang</span>
                    </a>
                </li>

                <li class="sidebar-item {{ request()->routeIs('admin.pengadaans.index') ? 'active' : '' }}">
                    <a href="{{ route('admin.pengadaans.index') }}" class="sidebar-link" wire:navigate>
                    <i class="bi bi-clipboard2-check-fill"></i>
                        <span>List Pengadaan</span>
                    </a>
                </li>

                <li class="sidebar-item {{ request()->routeIs('admin.logs.index') ? 'active' : '' }}">
                    <a href="{{ route('admin.logs.index') }}" class="sidebar-link"wire:navigate>
                ...
                <li class="sidebar-item {{ request()->routeIs('admin.users.index') ? 'active' : '' }}">
                    <a href="{{ route('admin.users.index') }}" class="sidebar-link" wire:navigate>
                        <i class="bi bi-people-fill"></i>
                        <span>Menejemen User</span>
                    </a>
                </li>

                <li class="sidebar-item {{ request()->routeIs('admin.profile.index') ? 'active' : '' }}">
                    <a href="{{ route('admin.profile.index') }}" class="sidebar-link" wire:navigate>
